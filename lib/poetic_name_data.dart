...
final List<Data> dataList = [
  Data(name: '初春', reading: 'はつはる', detail: '春の初めごろ。新年。', month: Month.january, isBeginning: true, isEnd: false, needPurchase: false),
  Data(name: '初霞', reading: 'はつがすみ', detail: '新年に山野にたなびく霞', month: Month.january, isBeginning: true, isEnd: false, needPurchase: false),
  ...
  Data(name: '若水', reading: 'わかみず', detail: '元日の朝に初めて汲む水', month: Month.january, isBeginning: true, isEnd: false, needPurchase: false),
  ...
  Data(name: '山眠る', reading: 'やまねむる', detail: '冬の山がいかにも眠っているように静まりかえる様子', month: Month.january, isBeginning: false, isEnd: true, needPurchase: false),
  Data(name: '福寿草', reading: 'ふくじゅそう', detail: '春の訪れを告げる花。元日草。朔日草。', month: Month.january, isBeginning: true, isEnd: false),
  Data(name: '初日', reading: 'はつひ', detail: '初日の出のこと', month: Month.january, isBeginning: true, isEnd: false, needPurchase: false),
  ...
  Data(name: '梅が枝', reading: 'うめがえ', detail: '正月に宮中で行われた儀式。梅が枝うたう。', month: Month.january, isBeginning: true, isEnd: false, needPurchase: false),
  Data(name: '幾千代', reading: 'いくちよ', detail: '何世代にも長きにわたる時間の流れ', month: Month.january, isBeginning: true, isEnd: true, needPurchase: false),
  Data(name: '老松', reading: 'おいまつ', detail: '長い年月を経た松。転じて、人物や組織の末長い繁栄を願う象徴。', month: Month.january, isBeginning: true, isEnd: true, needPurchase: false),
  ...
  Data(name: '常盤', reading: 'ときわ', detail: '永久不変であること', month: Month.january, isBeginning: true, isEnd: false, needPurchase: false),
  Data(name: '初笑', reading: 'はつわらい', detail: '新年初めての笑い', month: Month.january, isBeginning: true, isEnd: false, needPurchase: false),
  Data(name: '春駒', reading: 'はるこま', detail: '正月に各戸を回り、馬の首の形をしたものを持って歌い踊ること', month: Month.january, isBeginning: true, isEnd: false),

  Data(name: '節分', reading: 'せつぶん', detail: '立春の前日に行われる厄除けの行事', month: Month.february, isBeginning: true, isEnd: false, needPurchase: false),
  Data(name: '立春', reading: 'りっしゅん', detail: '春の始まり。二十四節気の一つ。', month: Month.february, isBeginning: true, isEnd: false, needPurchase: false),
  ...
  Data(name: '春嵐', reading: 'はるあらし', detail: '春に吹き荒れる強い風', month: Month.february, isBeginning: true, isEnd: true, needPurchase: false),
  Data(name: '東風', reading: 'こち', detail: '春に東から吹いてくる風', month: Month.february, isBeginning: true, isEnd: true, needPurchase: false),
  Data(name: '寒梅', reading: 'かんばい', detail: '寒い中花を咲かせる梅', month: Month.february, isBeginning: false, isEnd: true),
  Data(name: '雪解', reading: 'ゆきげ', detail: '春になり雪が溶けること', month: Month.february, isBeginning: false, isEnd: true, needPurchase: false),
  ...
  Data(name: '谷渡り', reading: 'たにわたり', detail: '春先の鶯の鳴き声。ホーホケキョ。', month: Month.february, isBeginning: true, isEnd: true, needPurchase: false),
  Data(name: '下萌', reading: 'したもえ', detail: '枯れ草の下から草の芽が萌え出る様子', month: Month.february, isBeginning: false, isEnd: true, needPurchase: false),
  ...
  Data(name: '草萌', reading: 'くさもえ', detail: '草の芽が萌え出る様子', month: Month.february, isBeginning: false, isEnd: true, needPurchase: false),
  ...
  Data(name: '紅梅', reading: 'こうばい', detail: '赤い花を咲かせる梅', month: Month.february, isBeginning: false, isEnd: true, needPurchase: false),
  ...
  Data(name: '梅花', reading: 'ばいか', detail: '梅の花', month: Month.february, isBeginning: true, isEnd: true, needPurchase: false),

  Data(name: '春分', reading: 'しゅんぶん', detail: '日が長くなっていき、本格的に春の到来を感じる頃。二十四節気の一つ。', month: Month.march, isBeginning: false, isEnd: true, needPurchase: false),
  Data(name: '春暁', reading: 'しゅんぎょう', detail: '春の日の明け方の様子', month: Month.march, isBeginning: false, isEnd: true, needPurchase: false),
  ...
  Data(name: '春一番', reading: 'はるいちばん', detail: '春先に吹く南寄りの強い風', month: Month.march, isBeginning: true, isEnd: false, needPurchase: false),
  Data(name: '淡雪', reading: 'あわゆき', detail: '春先のふわふわした消えやすい雪', month: Month.march, isBeginning: true, isEnd: false),
  Data(name: '雪間', reading: 'ゆきま', detail: '雪が溶けて地面が覗く様子', month: Month.march, isBeginning: true, isEnd: false, needPurchase: false),
  ...
  Data(name: '帰雁', reading: 'きがん', detail: '雁が春に北へ帰って行くこと', month: Month.march, isBeginning: true, isEnd: true, needPurchase: false),
  ...
  Data(name: '早蕨', reading: 'さわらび', detail: 'わらびが芽を出した様子', month: Month.march, isBeginning: true, isEnd: false, needPurchase: false),
  Data(name: '花暦', reading: 'はなごよみ', detail: '花の咲く季節や名所を記した暦', month: Month.march, isBeginning: true, isEnd: true, needPurchase: false),
  ...
  Data(name: '若草', reading: 'わかくさ', detail: '芽を出したところの柔らかな草', month: Month.march, isBeginning: false, isEnd: true, needPurchase: false),
  ...
  Data(name: '初筏', reading: 'はついかだ', detail: '木材業者が初荷が届いたことを祝って組む筏のこと', month: Month.march, isBeginning: true, isEnd: false, needPurchase: false),
  Data(name: '雛祭', reading: 'ひなまつり', detail: '女子の健やかな成長を祈る節句の年中行事', month: Month.march, isBeginning: true, isEnd: false, needPurchase: false),

  Data(name: '仏生会', reading: 'ぶっしょうえ', detail: '釈迦の誕生を祝う仏教行事。4月8日に行われる。花祭ともいう。', month: Month.april, isBeginning: true, isEnd: false, needPurchase: false),
  Data(name: '春眠', reading: 'しゅんみん', detail: '春は暖かく思わずよく寝てしまうこと', month: Month.april, isBeginning: true, isEnd: false, needPurchase: false),
  Data(name: '山笑う', reading: 'やまわらう', detail: '春になり草木が芽吹くことで山々が色づく様子', month: Month.april, isBeginning: true, isEnd: true, needPurchase: false),
  Data(name: '春雷', reading: 'しゅんらい', detail: '春に鳴る雷のこと', month: Month.april, isBeginning: true, isEnd: true, needPurchase: false),
  Data(name: '胡蝶', reading: 'こちょう', detail: '蝶の異称', month: Month.april, isBeginning: true, isEnd: true, needPurchase: false),
  ...
  Data(name: '花冷', reading: 'はなびえ', detail: '桜が咲くころに急に寒くなること', month: Month.april, isBeginning: true, isEnd: false, needPurchase: false),
  ...
  Data(name: '夜桜', reading: 'よざくら', detail: '夜に見る桜のこと', month: Month.april, isBeginning: true, isEnd: false, needPurchase: false),
  ...
  Data(name: '雲雀', reading: 'ひばり', detail: '春を告げると言われる鳥', month: Month.april, isBeginning: true, isEnd: true, needPurchase: false),
  Data(name: '花車', reading: 'はなぐるま', detail: '花で飾った車のこと', month: Month.april, isBeginning: true, isEnd: false),
  Data(name: '忘れ雪', reading: 'わすれゆき', detail: '春になっても残っている雪', month: Month.april, isBeginning: true, isEnd: false, needPurchase: false),
  Data(name: '玉柳', reading: 'たまやなぎ', detail: '柳の美称', month: Month.april, isBeginning: true, isEnd: true, needPurchase: false),
  Data(name: '花祭', reading: 'はなまつり', detail: '釈迦の誕生を祝う仏教行事。4月8日に行われる。仏生会ともいう。', month: Month.april, isBeginning: true, isEnd: false),

  Data(name: '八十八夜', reading: 'はちじゅうはちや', detail: '立春から数えて88日目の夜。5月2日ごろになる。', month: Month.may, isBeginning: true, isEnd: false, needPurchase: false),
  Data(name: '薫風', reading: 'くんぷう', detail: '初夏の若葉や青葉の香りを含んだ穏やかな風', month: Month.may, isBeginning: true, isEnd: true, needPurchase: false),
  Data(name: '早苗', reading: 'さなえ', detail: '苗代から田へ植えかえるころの稲の苗のこと', month: Month.may, isBeginning: true, isEnd: true),
  Data(name: '苔清水', reading: 'こけしみず', detail: '苔の間を流れる清らかな水', month: Month.may, isBeginning: true, isEnd: true, needPurchase: false),
  Data(name: '鵜飼', reading: 'うかい', detail: '飼い慣らした鵜を使って鮎などを獲る伝統的な漁法', month: Month.may, isBeginning: true, isEnd: true, needPurchase: false),
  Data(name: '青嵐', reading: 'あおあらし', detail: '青葉のころに吹くやや強い風', month: Month.may, isBeginning: true, isEnd: true),
  Data(name: '石清水', reading: 'いわしみず', detail: '岩陰から流れる清らかな水', month: Month.may, isBeginning: true, isEnd: true, needPurchase: false),
  Data(name: '草笛', reading: 'くさぶえ', detail: '草の茎や葉を巻いたりして吹く笛', month: Month.may, isBeginning: true, isEnd: true),
  Data(name: '雲の峰', reading: 'くものみね', detail: '山の峰のようにそびえ立つ積雲', month: Month.may, isBeginning: false, isEnd: true, needPurchase: false),
  ...
  Data(name: '青雲', reading: 'せいうん', detail: 'よく晴れた青い空', month: Month.may, isBeginning: true, isEnd: true, needPurchase: false),
  Data(name: '早乙女', reading: 'さおとめ', detail: '田植えの日に苗を田に植える女性', month: Month.may, isBeginning: true, isEnd: false, needPurchase: false),
  ...
  Data(name: '花菖蒲', reading: 'はなしょうぶ', detail: '5月から6月に咲く花。端午の節句で飾る。杜若。', month: Month.may, isBeginning: false, isEnd: true, needPurchase: false),
  Data(name: '青苔', reading: 'あおごけ', detail: '青色の苔', month: Month.may, isBeginning: true, isEnd: true),
  Data(name: '藤波', reading: 'ふじなみ', detail: '藤の花が風に吹かれて揺れ動く様子', month: Month.may, isBeginning: true, isEnd: false, needPurchase: false),
  ...
  Data(name: '夏至', reading: 'げし', detail: '一年のうちで最も昼の時間が長いころ。二十四節気の一つ。', month: Month.june, isBeginning: false, isEnd: true, needPurchase: false),
  Data(name: '梅雨', reading: 'つゆ', detail: '6月ごろに来る曇りや雨の多い期間のこと', month: Month.june, isBeginning: true, isEnd: true, needPurchase: false),
  Data(name: '空梅雨', reading: 'からつゆ', detail: 'ほとんど雨が降らない梅雨のこと', month: Month.june, isBeginning: true, isEnd: true, needPurchase: false),
  Data(name: '白南風', reading: 'しろはえ', detail: '梅雨の終わりに南側から吹く風', month: Month.june, isBeginning: false, isEnd: true, needPurchase: false),
  Data(name: '漁火', reading: 'いさりび', detail: '魚を誘き寄せるために船でたく火', month: Month.june, isBeginning: true, isEnd: true, needPurchase: false),
  ...
  Data(name: '蛍狩り', reading: 'ほたるがり', detail: '蛍の飛び回る景色を楽しむ遊び', month: Month.june, isBeginning: false, isEnd: true, needPurchase: false),
  Data(name: '長雨', reading: 'ながあめ', detail: '数日にわたって降り続く雨', month: Month.june, isBeginning: true, isEnd: true),
  Data(name: '雨宿', reading: 'あまやどり', detail: '雨が止むまで軒下などで待つこと', month: Month.june, isBeginning: true, isEnd: true, needPurchase: false),
  ...
  Data(name: 'せせらぎ', reading: 'せせらぎ', detail: '浅瀬を流れる水の音', month: Month.june, isBeginning: true, isEnd: true, needPurchase: false),
  ...
  Data(name: '洗心', reading: 'せんしん', detail: '心の汚れを清めるという意味の禅語', month: Month.june, isBeginning: true, isEnd: true, needPurchase: false),
  ...
  Data(name: '若竹', reading: 'わかたけ', detail: '夏になり生えてくる竹のこと', month: Month.june, isBeginning: true, isEnd: true, needPurchase: false),
  ...
  Data(name: '氷室', reading: 'ひむろ', detail: '冬場にできた天然の氷を溶けないように保管する施設', month: Month.july, isBeginning: true, isEnd: true, needPurchase: false),
  ...
  Data(name: '笹舟', reading: 'ささぶね', detail: '笹の葉で作った舟', month: Month.july, isBeginning: true, isEnd: false, needPurchase: false),
  Data(name: '山滴る', reading: 'やましたたる', detail: '夏に山の木々が瑞々しく生き生きとしている様子', month: Month.july, isBeginning: true, isEnd: true),
  Data(name: '夏子立', reading: 'なつこだち', detail: '夏に木々が葉を青々と茂らせる様子', month: Month.july, isBeginning: false, isEnd: true, needPurchase: false),
  Data(name: '夕凪', reading: 'ゆうなぎ', detail: '海辺の地域で、夕方に起こる無風の状態', month: Month.july, isBeginning: true, isEnd: true),
  Data(name: '山清水', reading: 'やましみず', detail: '山に流れる清らかな水', month: Month.july, isBeginning: true, isEnd: true, needPurchase: false),
  Data(name: '七夕', reading: 'たなばた', detail: '旧暦の7月7日の夜に行われる行事', month: Month.july, isBeginning: true, isEnd: false, needPurchase: false),
  Data(name: '織姫', reading: 'おりひめ', detail: '七夕の伝説に登場する仙女', month: Month.july, isBeginning: true, isEnd: false),
  Data(name: '風鈴', reading: 'ふうりん', detail: '夏に家の軒下などに吊り下げて用いられる小型の鐘鈴', month: Month.july, isBeginning: true, isEnd: true, needPurchase: false),
  ...
  Data(name: '青田', reading: 'あおた', detail: '夏が深まり稲が育ってきた水田', month: Month.july, isBeginning: false, isEnd: true, needPurchase: false),
  Data(name: '涼扇', reading: 'りょうせん', detail: '夏場に涼をとるための扇', month: Month.july, isBeginning: true, isEnd: true, needPurchase: false),
  ...
  Data(name: '舟遊び', reading: 'ふなあそび', detail: '舟の上で涼をとること', month: Month.july, isBeginning: true, isEnd: true, needPurchase: false),
  Data(name: '夕顔', reading: 'ゆうがお', detail: '夕暮れに白い花を咲かせる花', month: Month.july, isBeginning: true, isEnd: false),
  Data(name: '雲の海', reading: 'くものうみ', detail: '高い山から見下ろしたとき雲を海に喩える表現', month: Month.july, isBeginning: true, isEnd: true, needPurchase: false),
  ...
  Data(name: '立秋', reading: 'りっしゅう', detail: '夏が極まり秋の気配が立ち始める日。二十四節気の一つ。', month: Month.august, isBeginning: true, isEnd: false, needPurchase: false),
  Data(name: '処暑', reading: 'しょしょ', detail: '暑さが峠を越えて後退し始めるころ。二十四節気の一つ。', month: Month.august, isBeginning: false, isEnd: true, needPurchase: false),
  Data(name: '初嵐', reading: 'はつあらし', detail: '秋になって初めて吹く風', month: Month.august, isBeginning: false, isEnd: true, needPurchase: false),
  Data(name: '蝉時雨', reading: 'せみしぐれ', detail: '多くのセミが一斉に鳴きたてる声を時雨の降る音に見立てた語', month: Month.august, isBeginning: true, isEnd: true, needPurchase: false),
  ...
  Data(name: '稲妻', reading: 'いなづま', detail: '秋の荒天時に空に走る閃光', month: Month.august, isBeginning: false, isEnd: true, needPurchase: false),
  ...
  Data(name: '苔筵', reading: 'こけむしろ', detail: '苔が一面に広がり敷物のようになっている様子', month: Month.august, isBeginning: true, isEnd: true, needPurchase: false),
  ...
  Data(name: '夕立', reading: 'ゆうだち', detail: '夏の午後から夕方にかけてよく見られる天気', month: Month.august, isBeginning: true, isEnd: true, needPurchase: false),
  Data(name: '浦風', reading: 'うらかぜ', detail: '海辺に吹く風', month: Month.august, isBeginning: true, isEnd: true, needPurchase: false),
  Data(name: '女郎花', reading: 'おみなえし', detail: '秋の七草の一つ。敗醤。', month: Month.august, isBeginning: false, isEnd: true),
  Data(name: '榊', reading: 'さかき', detail: '神棚や祭壇に供えるなど神事にも用いられる植物', month: Month.august, isBeginning: true, isEnd: false, needPurchase: false),
  ...
  Data(name: '涼風', reading: 'すずかぜ', detail: '夏の終わりに吹く涼しい風', month: Month.august, isBeginning: false, isEnd: true, needPurchase: false),

  Data(name: '重陽', reading: 'ちょうよう', detail: '五節句の一つで、9月9日のこと。菊が咲く季節であることから菊の節句とも呼ばれる。', month: Month.september, isBeginning: true, isEnd: false, needPurchase: false),
  Data(name: '秋分', reading: 'しゅうぶん', detail: '昼と夜の長さがほぼ同じになるころ。二十四節気の一つ。', month: Month.september, isBeginning: false, isEnd: true, needPurchase: false),
  Data(name: '満月', reading: 'まんげつ', detail: '丸く満ちた月のこと', month: Month.september, isBeginning: true, isEnd: false, needPurchase: false),
  Data(name: '待宵', reading: 'まつよい', detail: '十五夜の前日の夜のこと', month: Month.september, isBeginning: true, isEnd: true),
  Data(name: '十五夜', reading: 'じゅうごや', detail: '旧暦8月15日の夜のことで、月を鑑賞する風習がある', month: Month.september, isBeginning: true, isEnd: true, needPurchase: false),
  ...
  Data(name: '虫の音', reading: 'むしのね', detail: '虫の鳴く声', month: Month.september, isBeginning: true, isEnd: true, needPurchase: false),
  Data(name: '秋の声', reading: 'あきのこえ', detail: '秋になって聞こえてくる風や虫などの自然の音', month: Month.september, isBeginning: true, isEnd: true),
  Data(name: '鈴虫', reading: 'すずむし', detail: '秋の夜の鳴き声が楽しむ対象とされる昆虫', month: Month.september, isBeginning: true, isEnd: true, needPurchase: false),
  ...
  Data(name: '虫籠', reading: 'むしかご', detail: '虫を入れておくかご', month: Month.september, isBeginning: true, isEnd: true, needPurchase: false),
  ...
  Data(name: '有明', reading: 'ありあけ', detail: '夜明けのこと', month: Month.september, isBeginning: true, isEnd: true, needPurchase: false),
  Data(name: '雁が音', reading: 'かりがね', detail: '雁の鳴き声。また雁自体を指すこともある。', month: Month.september, isBeginning: true, isEnd: false),
  Data(name: '雁鳴く', reading: 'かりなく', detail: '雁が鳴く様子', month: Month.september, isBeginning: true, isEnd: false, needPurchase: false),
  Data(name: '芝の戸', reading: 'しばのと', detail: '芝を編んで作った戸', month: Month.september, isBeginning: true, isEnd: true),
  Data(name: '宵闇', reading: 'よいやみ', detail: '月の出が遅く、暗い宵のこと', month: Month.september, isBeginning: true, isEnd: true, needPurchase: false),
  Data(name: '白露', reading: 'はくろ', detail: '大気が冷えてきて、露ができ始めるころ。二十四節気の一つ。', month: Month.september, isBeginning: false, isEnd: true),

  Data(name: '金風', reading: 'きんぷう', detail: '秋に吹く風', month: Month.october, isBeginning: true, isEnd: false, needPurchase: false),
  Data(name: '夜寒', reading: 'よさむ', detail: '秋が深まり夜の寒さが際立つこと', month: Month.october, isBeginning: false, isEnd: true),
  Data(name: '竜田姫', reading: 'たつたひめ', detail: '平城京の西に位置する竜田山に宿る秋の女神', month: Month.october, isBeginning: true, isEnd: true, needPurchase: false),
  Data(name: '残月', reading: 'ざんげつ', detail: '夜明けの頃に見える月', month: Month.october, isBeginning: true, isEnd: false, needPurchase: false),
  Data(name: '夕紅葉', reading: 'ゆうもみじ', detail: '夕日に映える紅葉', month: Month.october, isBeginning: false, isEnd: true, needPurchase: false),
  ...
  Data(name: '山粧う', reading: 'やまよそおう', detail: '紅葉で美しく飾ったような秋の山を形容する言葉', month: Month.october, isBeginning: true, isEnd: true, needPurchase: false),
  ...
  Data(name: '八重菊', reading: 'やえぎく', detail: '八重咲きの菊のこと', month: Month.october, isBeginning: true, isEnd: true, needPurchase: false),
  ...
  Data(name: '山路の秋', reading: 'やまじのあき', detail: '秋に紅葉した山の道', month: Month.october, isBeginning: false, isEnd: true, needPurchase: false),
  Data(name: '小柴垣', reading: 'こしばがき', detail: '細い芝で作る生垣', month: Month.october, isBeginning: true, isEnd: false),
  Data(name: '残菊', reading: 'ざんぎく', detail: '重陽の節句を過ぎた後に咲いている菊', month: Month.october, isBeginning: false, isEnd: true, needPurchase: false),
  Data(name: '山景', reading: 'さんけい', detail: '山の景色', month: Month.october, isBeginning: true, isEnd: false),
  Data(name: '薄紅葉', reading: 'うすもみじ', detail: '薄く色づいた紅葉', month: Month.october, isBeginning: false, isEnd: true, needPurchase: false),
  Data(name: '秋晴', reading: 'あきばれ', detail: '青々と澄んだ秋の空', month: Month.october, isBeginning: true, isEnd: true),
  Data(name: '秋時雨', reading: 'あきしぐれ', detail: '秋の終わりの頃に降る時雨', month: Month.october, isBeginning: false, isEnd: true, needPurchase: false),

  Data(name: '木枯し', reading: 'こがらし', detail: '晩秋から初冬にかけて吹く北寄りの強い風', month: Month.november, isBeginning: false, isEnd: true, needPurchase: false),
  ...
  Data(name: '霜枯れ', reading: 'しもがれ', detail: '冬に草木が霜で枯れること', month: Month.november, isBeginning: false, isEnd: true, needPurchase: false),
  ...
  Data(name: '錦秋', reading: 'きんしゅう', detail: '紅葉が錦のように美しい秋', month: Month.november, isBeginning: true, isEnd: true, needPurchase: false),
  Data(name: '山の錦', reading: 'やまのにしき', detail: '山の紅葉が錦のように美しい様子', month: Month.november, isBeginning: true, isEnd: true),
  Data(name: '落穂', reading: 'おちぼ', detail: '穀物の収穫の後に田畑に穂が散らばる様子', month: Month.november, isBeginning: true, isEnd: false, needPurchase: false),
  Data(name: '野菊', reading: 'のぎく', detail: '山野に咲く菊', month: Month.november, isBeginning: true, isEnd: true),
  Data(name: '小倉山', reading: 'おぐらやま', detail: '京都市西部の嵐山の向かいにある紅葉の名所', month: Month.november, isBeginning: true, isEnd: true, needPurchase: false),
  Data(name: '楓', reading: 'かえで', detail: '秋に紅葉する落葉高木。もみじ。', month: Month.november, isBeginning: true, isEnd: true),
  Data(name: '落葉', reading: 'らくよう', detail: '落葉樹が秋から冬にかけて葉を落とすこと', month: Month.november, isBeginning: false, isEnd: true, needPurchase: false),
  ...
  Data(name: '山居', reading: 'さんきょ', detail: '山の中の住まい', month: Month.november, isBeginning: true, isEnd: true, needPurchase: false),
  ...
  Data(name: '散紅葉', reading: 'ちりもみじ', detail: 'もみじが散りゆく様子', month: Month.november, isBeginning: false, isEnd: true, needPurchase: false),
  ...
  Data(name: '秋霜', reading: 'あきしも', detail: '秋の厳しい霜', month: Month.november, isBeginning: false, isEnd: true, needPurchase: false),
  Data(name: '酒林', reading: 'さかばやし', detail: '新酒ができたことを知らせるために軒下に吊るすもの', month: Month.november, isBeginning: true, isEnd: true, needPurchase: false),

  Data(name: '冬至', reading: 'とうじ', detail: '一年のうち最も昼の時間が短いころ。二十四節気の一つ。', month: Month.december, isBeginning: false, isEnd: true, needPurchase: false),
  Data(name: '大雪', reading: 'おおゆき', detail: '雪が激しく降り始めるころ。二十四節気の一つ。', month: Month.december, isBeginning: true, isEnd: false),
  Data(name: '冬木立', reading: 'ふゆこだち', detail: '冬になり落葉した木々のこと', month: Month.december, isBeginning: true, isEnd: true, needPurchase: false),
  ...
  Data(name: '薄氷', reading: 'うすごおり', detail: '薄く張った氷', month: Month.december, isBeginning: true, isEnd: true, needPurchase: false),
  Data(name: '氷柱', reading: 'つらら', detail: '建物の軒下や岩場などから棒状に伸びた氷', month: Month.december, isBeginning: true, isEnd: true, needPurchase: false),
  ...
  Data(name: '年忘れ', reading: 'としわすれ', detail: 'その一年にあった苦労を忘れること', month: Month.december, isBeginning: false, isEnd: true, needPurchase: false),
  ...
  Data(name: '晩鐘', reading: 'ばんしょう', detail: '寺院や教会などで夕方に鳴らす鐘', month: Month.december, isBeginning: true, isEnd: true, needPurchase: false),
  ...
  Data(name: '寒月', reading: 'かんげつ', detail: '寒い冬の夜に冴え渡る月', month: Month.december, isBeginning: true, isEnd: true, needPurchase: false),
  Data(name: '初霜', reading: 'はつしも', detail: 'その冬初めて降りる霜', month: Month.december, isBeginning: true, isEnd: true),
  Data(name: '初雪', reading: 'はつゆき', detail: 'その冬初めて降りる雪', month: Month.december, isBeginning: true, isEnd: true, needPurchase: false),
  Data(name: '千秋楽', reading: 'せんしゅうらく', detail: '複数日にわたって同じ演目を行う興行の最終日', month: Month.december, isBeginning: false, isEnd: true, needPurchase: false),
  ...
  Data(name: '夕千鳥', reading: 'ゆうちどり', detail: '夕方に飛んでいる千鳥', month: Month.december, isBeginning: true, isEnd: true, needPurchase: false),
  ...
  Data(name: '一陽来復', reading: 'いちようらいふく', detail: '冬至を過ぎて日脚が長くなる様子', month: Month.december, isBeginning: false, isEnd: true, needPurchase: false),
];